...
function draw(){
 ...
 bubbles = svg.append("g")
  ...
  bubbles.append("circle")
      ...
      .attr("stroke-width", function(d){return d.cluster})
...
function cluster(alpha) {
  return function(d) {
    ...
    // console.log("dx", indice(d.sub));
    //
    //   var x = d.x - xx[indice(d.sub)],
    //       y = d.y - yy,
    //       l = Math.sqrt(x * x + y * y),
    //       r = d.r + raio;
    //        console.log("dx", xx[indice(d.sub)]);
    //
    //   if (l != r) {
    //     l = (l - r) / l * 0.01;
    //     d.x -= x *= l;
...
//
// var k = parseInt(n);
// //  add(hm, clusters[parseInt(n)].values);
//   console.log("aa",k);
//   add(hm, clusters[parseInt(k)].values);
  //draw2(hm);
}
